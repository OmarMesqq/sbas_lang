...
debug:
	gcc -g -Wall -Wextra main.c sbas.c utils.c -o $(OUTPUT) -lm

release:
	gcc -O3 -Wall -Wextra  main.c sbas.c utils.c -o $(OUTPUT) -lm

test:
	gcc -g -Wall -Wextra run_tests.c sbas.c utils.c -o $(TEST_OUTPUT)
